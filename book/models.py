...
class Schedule(models.Model):
    ...
    def __str__(self):
        return f'{self.visitor.username} - {self.date_of_visit} - {self.time_of_visit}, {self.number_of_visitors} visitors - for {self.number_of_hours} hours'
...
class Number_of_tables_to_order(models.Model):
    ...
    def __str__(self):
        return f'For {self.visitor_number} visitors need {self.table_number} tables'
